...
namespace Minor.Case2.PcSOnderhoud.Implementation.Tests
{
    ...
    public class VoegOnderhoudswerkzaamhedenToe
    {
        ...
        public void ReturnsNullableBool()
        {
            ...
            agentBSMock.Setup(agent => agent.GetOnderhoudsopdrachtenBy(It.IsAny<Schema.OnderhoudsopdrachtZoekCriteria>())).Returns(new Schema.OnderhoudsopdrachtenCollection());
            ...
            agentBSMock.Setup(agent => agent.GetVoertuigBy(It.IsAny<Schema.VoertuigenSearchCriteria>())).Returns(new Schema.VoertuigenCollection());
            agentISMock.Setup(
                agent =>
                    agent.SendAPKKeuringsverzoek(It.IsAny<Schema.Voertuig>(), It.IsAny<AgentSchema.Garage>(),
